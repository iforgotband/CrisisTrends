...
(function () {
    ...
    window.renderFAQ = () => {
         ...
         * @type {Element}
         */
        const _destination = document.getElementsByClassName(
            'faq-placeholder')[0];
         ...
         * @type {Element}
         */
        const _section = document.getElementsByClassName(
            'template faq-section')[0];
         ...
         */
        const _subsection =
            document.getElementsByClassName('template faq-subsection')[
                0];
        ...
        for (let sectionTitle in window.faq) {
            ...
            _thisSection.querySelectorAll('h1')[0].innerHTML =
                sectionTitle;
            _thisSection.querySelectorAll('img')[0].src = section.image;

            const _thisDestination = _thisSection.querySelectorAll(
                '.faq-content')[0];
            ...
            for (let subsectionTitle in section.questions) {
                ...
                if (typeof subsection === 'string') {
                    // we have a question
                    addQuestion(subsectionTitle, subsection,
                        _thisDestination);
                } else {
                    // we have a subsection
                    const _thisSubsection = _subsection.cloneNode(true);

                    _thisSubsection.querySelectorAll('h2')[0].innerHTML =
                        subsectionTitle;
                    ...
                    for (let question in subsection) {
                        ...
                        addQuestion(question, subsection[question],
                            _thisSubsection);
                    }
        ...
        function addQuestion(question, answer, appendTo) {
            ...
            _thisQuestion.querySelectorAll('h3')[0].innerHTML =
                question;
            _thisQuestion.querySelectorAll('p')[0].innerHTML =
                answer;
